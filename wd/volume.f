...
c modified Apr 16th 2016 by MB
     ...
     $  GMAG1,GMAG2,glog1,glog2,GREXP,IFC)
...
c  Version of December 5, 2003
     ...
     $  CSFI(*),GRV1(*),GRV2(*),GLUMP1(*),GLUMP2(*),XX1(*),YY1(*),
     $  ZZ1(*),XX2(*),YY2(*),ZZ2(*),CSBT1(*),CSBT2(*),GMAG1(*),GMAG2(*),
     $  glog1(*),glog2(*)
   ...
   16 continue
     ...
     $      MMSAVE,FR1,FR2,HLD,FF,D,SNTH,CSTH,SNFI,CSFI,GRV1,GRV2,XX1,
     $      YY1,ZZ1,XX2,YY2,ZZ2,CSBT1,CSBT2,GLUMP1,GLUMP2,GMAG1,GMAG2,
     $      glog1,glog2,grexp)

          IF(KOMP.EQ.2) then
            call lum(1.d0,1.d0,0.d0,1.d0,n,n1,2,sbrd,rv,rvq,glump1,
     $        glump2,glog1,glog2,grv1,grv2,mmsave,summ,fr2,sm,0,vol,q,p,
     $        ff,d,snth,7)
          else
            call lum(1.d0,1.d0,0.d0,1.d0,n,n1,1,sbrd,rv,rvq,glump1,
     $        glump2,glog1,glog2,grv1,grv2,mmsave,summ,fr1,sm,0,vol,q,p,
     $        ff,d,snth,7)
          endif
