...
eta1 = sqrt(1.-e1**2)
dotOmega = -3./2.*n1*J2*(R1/a1)**2*cos(i1)/eta1**4  # standard coefficients; Bertotti etal. (2003), p. 332
...
p \
  ...
  "../../test_oblat4_63.4deg/xvpl2el/xvpl2el.out" u (($1-T0)*day/yr):(f($6)) w lp,\
  "../../test_oblat5_80deg/xvpl2el/xvpl2el.out" u (($1-T0)*day/yr):(f($6)) w lp,\
