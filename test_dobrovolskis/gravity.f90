...
double precision, dimension(3,3) :: I_, evector, evector_, evector__, Itmp
double precision, dimension(3) :: dtmp, etmp
...
write(*,*) 'rotated to m.o.i. (about 3 axes), wo. density profile'
write(*,*)
