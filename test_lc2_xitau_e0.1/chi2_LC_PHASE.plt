...
p \
  "lightcurve.dat" u (phase($1)-0.220):($2+($3-band)*shift) w lp pt 1 lw 3 lc 'orange' t "synthetic",\
  "../test_lc1_wd_e0.1/lc.out" u ($2-0.118):($3+0.006) w lp pt 1 lc 'cyan' t "WD",\
  "../test_lc0_phoebe2_e0.1/forward_model.txt" u 1:(-2.5*log10($2/1.0)+0.103) w lp pt 1 lc 'green' t "Phoebe2",\
