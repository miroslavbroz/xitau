...
sp \
  ...
  "<awk '($2==-1) && ($1 >= 2456224.7247049999) && ($1 <= 2456224.7247049999+6)' out_JDATE_heliocentric.dat" u 3:4:5 w l lw 2 lt 1,\
  "<awk '($2==-2) && ($1 >= 2456224.7247049999) && ($1 <= 2456224.7247049999+6)' out_JDATE_heliocentric.dat" u 3:4:5 w l lw 2 lt 2,\
  "<awk '($2==-3) && ($1 >= 2456224.7247049999) && ($1 <= 2456224.7247049999+6)' out_JDATE_heliocentric.dat" u 3:4:5 w l lw 2 lt 3,\
  "<awk '($2==-4) && ($1 >= 2456224.7247049999) && ($1 <= 2456224.7247049999+6)' out_JDATE_heliocentric.dat" u 3:4:5 w l lw 2 lt 4
pa -1
