...
GMST = (18.+41./60.+50./3600.)/12.*pi  # from Stellarium

sp \
  "world_50m.txt" u (fx(1,$1,$2)):(fy(1,$1,$2)):(fz(1,$1,$2)) w l lc 'black' not,\
  fx(1,u,v),fy(1,u,v),fz(1,u,v) lc 'gray' not,\
  "<awk 'BEGIN{ FS=\",\"; }{ print $1,$2; }' green.dat" u (fx(1,$1,$2)):(fy(1,$1,$2)):(fz(1,$1,$2)) w lp lc 1 pt 1 t "Occult",\
  "<awk '($8>0)' Kleopatra_occ" u (fx(1,$1,$2)):(fy(1,$1,$2)):(fz(1,$1,$2)) w p pt 4 lc 'blue' t "observed",\
  "<awk '($8<0)' Kleopatra_occ" u (fx(1,$1,$2)):(fy(1,$1,$2)):(fz(1,$1,$2)) w p pt 4 lc 'black' t "negative",\
  ...
  sprintf("<awk 'BEGIN{ for (i=-90;i<=90;i++){ print %f,i; }}'", -GMST/deg) u (fx(1,$1,$2)):(fy(1,$1,$2)):(fz(1,$1,$2)) w l lc '#00aa00' not,\
