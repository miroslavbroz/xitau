...
p \
  "lightcurve.dat" u (phase($1)):($2+($3-band)*shift) w p pt 1 lw 2 lc '#ff9900' t "synthetic",\
  "../test_lc1_wd_e0.5/lc.out" u 2:($3+0.0014) w l lw 2 lc 'cyan' t "WD",\
  "../test_lc0_phoebe2_e0.5/forward_model.txt" u ($1-0.155):(-2.5*log10($2/1.0)-0.031) w lp pt 1 lc 'green' t "Phoebe2",\
