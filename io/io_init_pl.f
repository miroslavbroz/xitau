...
c        if(  (xh(1).ne.0.0d0) .or.
c     &       (yh(1).ne.0.0d0) .or.
c     &       (zh(1).ne.0.0d0) .or.
c     &       (vxh(1).ne.0.0d0) .or.
c     &       (vyh(1).ne.0.0d0) .or.
c     &       (vzh(1).ne.0.0d0) ) then
c           write(*,*) ' SWIFT ERROR: in io_init_pl: '
c           write(*,*) '   Input MUST be in heliocentric coordinates '
c           write(*,*) '   Position and Vel. of Massive body 1 .ne. 0'
c           call util_exit(1)
c        endif
