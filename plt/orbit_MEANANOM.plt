...
p "<awk '($2==-2)' xv2el.out" u ($1-2400000):7 not w d lt 2

set origin 0,0.66
set yl "M [deg]"

p "<awk '($2==-2)' xv2el.out" u ($1-2400000):8 not w d lt 2
...
p "<awk '($2==-3)' xv2el.out" u ($1-2400000):7 not w d lt 3

set origin 0,0.66
set yl "M [deg]"

p "<awk '($2==-3)' xv2el.out" u ($1-2400000):8 not w d lt 3
...
p "<awk '($2==-4)' xv2el.out" u ($1-2400000):7 not w d lt 4

set origin 0,0.66
set yl "M [deg]"

p "<awk '($2==-4)' xv2el.out" u ($1-2400000):8 not w d lt 4
