...
p \
  "Clo.dat"          u (sqrt($2**2+$3**2)/$6):($10+$12*360):11 t "observed closure phase" w err lt 3 pt 1 ps 0.5,\
  "closurephase.dat" u (sqrt($2**2+$3**2)/$6):($8+$9*360)  t "synthetic closure phase" w p lt 7 pt 1,\
  "chi2_CLO.dat"     u (sqrt($2**2+$3**2)/$6):($10+$12*360) t "residua" w l lt 1 lw 1,\
  "<awk '($NF+0>100)' chi2_CLO.dat" u (sqrt($2**2+$3**2)/$6):($10+$12*360) t "chi^2 > 100" w p lt 1 pt 6 ps 1.5,\
