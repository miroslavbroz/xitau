...
p "<awk '{ i++; print i, $NF; }' chi2_func.tmp"      u 1:2 t "chi^2" w lp lt 1 ps 0.8,\
  "<awk '{ i++; print i, $(NF-17); }' chi2_func.tmp" u 1:2 t "SKY"   w l,\
  ...
  "<awk '{ i++; print i, $(NF-12); }' chi2_func.tmp" u 1:2 t "CLO"   w l lc '#000099',\
  ...
  "<awk '{ i++; print i, $(NF -9); }' chi2_func.tmp" u 1:2 t "SYN"   w l lw 2,\
  "<awk '{ i++; print i, $(NF -8); }' chi2_func.tmp" u 1:2 t "SED"   w l lw 2,\
  "<awk '{ i++; print i, $(NF -7); }' chi2_func.tmp" u 1:2 t "AO"    w l,\
  "<awk '{ i++; print i, $(NF -6); }' chi2_func.tmp" u 1:2 t "AO2"   w l,\
  "<awk '{ i++; print i, $(NF -5); }' chi2_func.tmp" u 1:2 t "SKY2"  w l,\
  "<awk '{ i++; print i, $(NF -4); }' chi2_func.tmp" u 1:2 t "SKY3"  w l,\
  "<awk '{ i++; print i, $(NF -3); }' chi2_func.tmp" u 1:2 t "OCC"   w l,\
  "<awk '{ i++; print i, $(NF -2); }' chi2_func.tmp" u 1:2 t "SED2"  w l,\
