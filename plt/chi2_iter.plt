...
p "<awk '{ i++; print i, $NF; }' chi2_func.tmp"      u 1:2 t "chi^2" w lp lt 1 ps 0.5,\
  ...
  "<awk '{ i++; print i, $(NF-13); }' chi2_func.tmp" u 1:2 t "RV"    w l,\
  "<awk '{ i++; print i, $(NF-12); }' chi2_func.tmp" u 1:2 t "TTV"   w l,\
  "<awk '{ i++; print i, $(NF-11); }' chi2_func.tmp" u 1:2 t "ECL"   w l,\
  "<awk '{ i++; print i, $(NF-10); }' chi2_func.tmp" u 1:2 t "VIS"   w l,\
  "<awk '{ i++; print i, $(NF -9); }' chi2_func.tmp" u 1:2 t "CLO"   w l,\
  "<awk '{ i++; print i, $(NF -8); }' chi2_func.tmp" u 1:2 t "T3"    w l dt 2,\
  "<awk '{ i++; print i, $(NF -7); }' chi2_func.tmp" u 1:2 t "LC"    w l,\
  "<awk '{ i++; print i, $(NF -6); }' chi2_func.tmp" u 1:2 t "SYN"   w l lw 2,\
  "<awk '{ i++; print i, $(NF -5); }' chi2_func.tmp" u 1:2 t "SED"   w l lw 2,\
