...
p \
  ...
  "<awk '(NR<4100)' Clo.dat"          u (sqrt($2**2+$3**2)/$6):($8+$12*2):9 t "observed T3 amplitude" w err lt 3 pt 1 ps 0.5,\
  "chi2_T3.dat"      u (sqrt($2**2+$3**2)/$6):($8+$12*2)   t "residua" w l lt 1 lw 1
pa -1
