...
p "<awk '($2==-2)' xv2el.out" u ($1-2400000):($3*au/R_S) not w l lt 2
...
p "<awk '($2==-2)' xv2el.out" u ($1-2400000):(g($6)) not w d lt 2

set origin 0,0.33
set yl "varpi [deg]"

p "<awk '($2==-2)' xv2el.out" u ($1-2400000):(g($6+$7)) not w d lt 2
...
p "<awk '($2==-3)' xv2el.out" u ($1-2400000):($3*au/R_S) not w l lt 3
...
p "<awk '($2==-3)' xv2el.out" u ($1-2400000):(g($6)) not w d lt 3

set origin 0,0.33
set yl "varpi [deg]"

p "<awk '($2==-3)' xv2el.out" u ($1-2400000):(g($6+$7)) not w d lt 3
...
p "<awk '($2==-4)' xv2el.out" u ($1-2400000):($3*au/R_S) not w l lt 4
...
p "<awk '($2==-4)' xv2el.out" u ($1-2400000):(g($6)) not w d lt 4

set origin 0,0.33
set yl "varpi [deg]"

p "<awk '($2==-4)' xv2el.out" u ($1-2400000):(g($6+$7)) not w d lt 4
